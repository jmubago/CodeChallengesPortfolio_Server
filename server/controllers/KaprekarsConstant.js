...
import { KaprekarsConstantChallenge } from '../challenges/KaprekarsConstantChallenge';

export default ((req, res) => {

    let num = req.body.number;

    let kaprekarsConstant = KaprekarsConstantChallenge(num)

    let challenge = new Response(kaprekarsConstant);
